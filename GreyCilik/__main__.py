...
✪ Cilik is a bot manager + music to manage your group well.
✪ Press /help for Help.
    ...
    if query.data == "cilik_":
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Aᴅᴍɪɴ", callback_data="cilik_admin"),
                    InlineKeyboardButton(text="Nᴏᴛᴇꜱ", callback_data="cilik_notes"),
                 ],
                 [
                    InlineKeyboardButton(text="Sᴜᴘᴘᴏʀᴛ", callback_data="cilik_support"),
                    InlineKeyboardButton(text="Cʀᴇᴅɪᴛ", callback_data="cilik_credit"),
                 ],
                 [
                    InlineKeyboardButton(text="Bᴀᴄᴋ", callback_data="cilik_back"),
